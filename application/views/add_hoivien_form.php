...
<section class="get-in-touch">
   <h1 class="title">THÔNG TIN ĐĂNG KÝ HỘI VIÊN</h1>
  
     
   
   <form class="contact-form row" action="<?php echo base_url() ?>/supporter/add_hoivien/<?php echo $id;?>" method="post" enctype="multipart/form-data">
      ...
      <div class="form-field col-lg-12">
         ...
         <label class="label" for="message">Username</label>
      </div>
      <div class="form-field col-lg-12">
         <input name="pw" class="input-text js-input" type="text" required>
         <label class="label" for="message">Password</label>
      </div>
      <div class="form-field col-lg-12">
         <input name="pw2" class="input-text js-input" type="text" required>
         <label class="label" for="message">RePassword</label>
      </div>
       <div class="form-field col-lg-12">
          
          <select style="height: 40px;font-size: 15px;" class="input-text" name="gioitinh" required>
      ...
      <div class="form-field col-lg-12">
         <input class="submit-btn" type="submit" value="Đăng ký hội viên">
      </div>
   </form>
</section>
