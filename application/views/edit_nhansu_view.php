...
<section class="get-in-touch">
   ...
   <form class="contact-form row" action="<?php echo base_url() ?>manager/update_nhansu" method="post" enctype="multipart/form-data">
      <div class="form-field col-lg-8">
         <input name="tennv" class="input-text" value="<?php echo $value['tennv'];  ?>" type="text" required>
         <label class="label" for="name">Họ và tên</label>
      </div>      
      <div class="form-field col-lg-6 ">
         <input name="dob" class="input-text" value="<?php echo $value['dob'];  ?>" type="date" required>
         <label class="label1" for="dob">Ngày tháng năm sinh</label>
      </div>
       <div class="form-field col-lg-6 ">
         <input name="sdt" class="input-text" value="<?php echo $value['sdt'];  ?>" type="text" required>
         <label class="label" for="phone">Số điện thoại</label>
      </div>
      <div class="form-field col-lg-12">
         <input name="chucvu" class="input-text" value="<?php echo $value['chucvu'];  ?>" type="text" required>
