...
<div class="container-fluid">
    <a href="<?php echo base_url(); ?>supporter" class="btn btn-warning btn-lg float-right mr-1 mt-4" style="  position: -webkit-sticky;
                  ...
                  <?php for($i=1;$i<8;$i++) {?>
                    <td align="center" height="50"> 
                      ...
                      <?php if ($value['ca']== $i&&$value['ngay']=='nay'&&$value['ghichu']==''): ?>
                        ...
                        <div class="text-left"><small><strong>Nhân viên :</strong> <?php echo $value['nhanvien'] ?></small></div>
                         <br>
                          ...
                          <?php if ($value['nhanvien']==''): ?>
                             <button class="btn btn-dark btn-sm" disabled>Chờ phân công nhân viên <i class="fa fa-spinner" aria-hidden="true"></i></button>   
                                <?php endif ?>
                                <?php if ($value['nhanvien']!=''): ?>
                             <button class="btn btn-info btn-sm" disabled>Chờ thanh toán <i class="fa fa-credit-card fa-md" aria-hidden="true" style="margin-left: 5px;"></i></button>   
                                <?php endif ?> 
                                <button onclick="delete_dichvu(<?php echo $value['id'];?>)" class="btn btn-danger btn-sm ">Hủy <i class="far fa-trash-alt fa-xs"> </i></button>
                                <?php endif ?>
                        ...
                        <button onclick="chot_dichvu(<?php echo $value['id'];?>)" class="btn btn-success btn-sm ">Chốt lịch thành công <i class="fas fa-edit fa-xs"> </i></button>
                        <button onclick="delete_dichvu(<?php echo $value['id'];?>)" class="btn btn-danger btn-sm ">Hủy  <i class="far fa-trash-alt fa-xs"> </i></button>
                      ...
                      <?php if ($value['ca']== $i&&$value['ngay']=='nay'&&$value['ghichu']!=''): ?>
                       ...
                       <div  class="text-left"><small><strong>Khách hàng :</strong><?php echo $value['tenkh'] ?></small></div>
                        ...
                        <br> 
                        <div class="text-center"><small>Phản hồi của admin :<br> 
                            <strong><?php echo $value['ghichu'] ?></strong>
                        </small></div>
                         <br>

                        <button onclick="delete_dichvu(<?php echo $value['id'];?>)" class="btn btn-info btn-sm ">Liên hệ hủy thành công  <i class="fa fa-phone fa-xs"> </i></button>
            ...
            <?php for($i=1;$i<8;$i++) {?>
                    <td align="center" height="50"> 
                      ...
                      <?php if ($x==0): ?>
                         ...
                         <div class="text-center"><small>Trống</small></div>
                         <button type="button" onclick="show(<?php echo $i;?>,'mai')" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-xs"></i></button>
                       <?php endif ?>
                       <br>
        <br>
                       </td>
              ...
              <?php for($i=1;$i<8;$i++) {?>
                    <td align="center" height="50"> 
                      ...
                      <?php if ($x==0): ?>
                         ...
                         <div class="text-center"><small>Trống</small></div>
                         <button type="button" onclick="show(<?php echo $i;?>,'kia')" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-xs"></i></button>
                       <?php endif ?>
                       <br>
        <br>
                       </td>
...
<div id="modalDialog" class="modal">
    <div class="modal-content animate-top " style="height:450px;">
        ...
        <form method="post" id="contactFrm" action="<?php echo base_url();?>supporter/insert_dichvu">
